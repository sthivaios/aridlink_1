  ...
  return (
    <div className="flex h-screen w-full flex-row items-center justify-center text-center ">
      ...
      <Card className="flex w-min flex-col items-center px-20 py-10">
        ...
        <Link
          href="/dashboard"
          className="flex w-full items-center justify-center gap-2 bg-primary py-2  text-sm font-semibold text-primary-foreground transition-opacity hover:opacity-90"
        >
          Head to dashboard
